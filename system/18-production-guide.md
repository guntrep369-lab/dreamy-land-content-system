...
7. ใส่โลโก้ช่องมุมภาพ + Brand Sound (เพลงเปิดประตู/jingle ปิด จากไฟล์ 19)
8. **เช็กความดัง:** เสียงรวมเฉลี่ย ~ -14 LUFS ไม่มีพีคแสบหู (CapCut: ดู audio meter อย่าให้แตะแดง)
9. ดูรวดเดียวจบ 1 รอบเต็ม → รัน **QC Checklist ไฟล์ 15 หมวด D** → **Export** 1080p 30fps → `5-edit/EP____final.mp4`
10. **ตัด Shorts 3 ชิ้น (A/B/C)** ตามไฟล์ 20 ก่อนปิดโปรเจกต์ — ตอนที่ timeline ยังเปิดอยู่ใช้เวลาแค่ ~45 นาที
